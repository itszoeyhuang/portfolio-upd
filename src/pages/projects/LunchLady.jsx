...
import OriginalLunchLady from '../../../public/video/old-lunch_lady.mp4'
import HifiMobile from '../../assets/images/the-lunch-lady/hifi-mobile.jpg'
import HifiTablet from '../../assets/images/the-lunch-lady/hifi-tablet.jpg'
import HifiDesktop from '../../assets/images/the-lunch-lady/hifi-desktop.jpg'
    ...
    return(
        ...
        <div className="container">
            ...
            <Content
                ...
                content={[
                    "The Lunch Lady is a Vancouver based local restaurant known for its vibrant and multicultural cuisine. However, the orginal website struggles to reflect this character - especially on mobile and desktop, where the layout was either cluttered or over exaggerated that makes the users hard to navigate.", "The redesign aims to refresh the website with a mobile-first approach, focusing on:", "#1 Improved Usaility - Easy browsing menu or finding restaurant info", "#2 - Cleaner Visual Hierarchy - Aims to reduce the overwhelming content and guides users natureally through the site.", "#3 Animation Update - I've ultilised more Javascript to make the user experience feel more engaging."
                ]}
            />
            <p>Screen-recording of Original Website</p>
            <Video src={OriginalLunchLady} />
            <Content
            ...
            <Content 
                ...
                content={["I began by mapping the key userflows - like browsing the menu and finding contact info. This helps me to create the low-fidilty wireframes which quickly test content hierachy and reduce mobile clutter.", "The hi-fidelity prototypes showing below demonstrate the site modification in both mobile, tablet, and desktop screen. "
                ]}
            />
            <p>Hi-fidelity Wireframes</p>
            <Wireframes
                images={[
                    { src: HifiMobile, alt:"Lunch Lady Mobile Wireframe",caption: "Mobile Screen - Off & Close Menu Display"},
                    { src: HifiTablet, alt:"Lunch Lady Tablet Wireframe",caption: "Tablet Screen"},
                    { src: HifiDesktop, alt:"Lunch Lady Desktop Wireframe",caption: "Desktop Screen"}
                ]}
            />
            <Content 
            ...
            />
            <p>Screen-recording of Redesigned Website</p>
