            ...
            <div className="about">
                ...
                <div className="about-right">
                    <div className="col-9">
                        ...
                        <div className="content">
                            <p>My goal is to build beautiful, functional websites, especially for emerging brands, creatives, and independent artists who need a strong online presence but might not have the technical resources to create one.</p>
                            <br />
